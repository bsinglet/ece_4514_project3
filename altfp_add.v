...
//VERSION_BEGIN 16.0 cbx_altbarrel_shift 2016:04:27:18:05:34:SJ cbx_altfp_add_sub 2016:04:27:18:05:34:SJ cbx_altpriority_encoder 2016:04:27:18:05:34:SJ cbx_cycloneii 2016:04:27:18:05:34:SJ cbx_lpm_add_sub 2016:04:27:18:05:34:SJ cbx_lpm_compare 2016:04:27:18:05:34:SJ cbx_mgl 2016:04:27:18:06:48:SJ cbx_nadder 2016:04:27:18:05:34:SJ cbx_stratix 2016:04:27:18:05:34:SJ cbx_stratixii 2016:04:27:18:05:34:SJ  VERSION_END
...
module  altfp_add_altbarrel_shift_ltd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //altfp_add_altbarrel_shift_ltd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altbarrel_shift_s0g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //altfp_add_altbarrel_shift_s0g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_2h9
	( 
	data,
	q,
	zero) ;
...
endmodule //altfp_add_altpriority_encoder_2h9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_d6b
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_altpriority_encoder_2h9   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	altfp_add_altpriority_encoder_2h9   altpriority_encoder24
	( 
	.data(data[15:8]),
...
endmodule //altfp_add_altpriority_encoder_d6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_229
	( 
	data,
	q) ;
	input   [7:0]  data;
...
endmodule //altfp_add_altpriority_encoder_229

//synthesis_resources = reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_ena
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_altpriority_encoder_2h9   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	altfp_add_altpriority_encoder_229   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //altfp_add_altpriority_encoder_ena

//synthesis_resources = reg 14 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altpriority_encoder_dna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_altpriority_encoder_d6b   altpriority_encoder21
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_altpriority_encoder_ena   altpriority_encoder22
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_add_altpriority_encoder_dna

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 816 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_altfp_add_sub_5vi
	( 
	clock,
	dataa,
	datab,
	...
	altfp_add_altbarrel_shift_ltd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_altbarrel_shift_s0g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_altpriority_encoder_dna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_add_altfp_add_sub_5vi
//VALID FILE
...
module altfp_add (
	...
	altfp_add_altfp_add_sub_5vi	altfp_add_altfp_add_sub_5vi_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_add.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_add.cmp TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_add.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_add_inst.v TRUE
